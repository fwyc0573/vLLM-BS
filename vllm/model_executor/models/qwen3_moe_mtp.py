...
"""Inference-only Qwen3MoE MTP model."""
...
class Qwen3MoeMultiTokenPredictor(nn.Module):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        config: Qwen3MoeConfig = model_config.hf_config
...
class Qwen3MoeMTP(nn.Module, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        super().__init__()
        config: Qwen3MoeConfig = vllm_config.model_config.hf_config
        quant_config = vllm_config.quant_config
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        def remap_weight_names(weight_iter: Iterable[tuple[str, torch.Tensor]]):
